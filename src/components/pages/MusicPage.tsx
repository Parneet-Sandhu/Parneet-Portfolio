      ...
      <div className="container max-w-4xl mx-auto space-y-8 relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-4xl md:text-5xl adventure-title">Music Corner</h2>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="font-body">Press play to listen on Spotify</span>
          </div>
        </motion.div>
        ...
        <div className="space-y-6">
          {favoriteSongs.map((song, index) => (
            ...
            >
              <div className="mb-3">
                <h3 className="text-2xl font-cartoon text-primary">{song.title}</h3>
                <p className="font-display font-semibold text-secondary">{song.artist}</p>
              </div>
        ...
        <motion.div
          ...
          className="section-card"
        >
          <h3 className="text-2xl font-cartoon text-primary mb-4 text-center">Favorite Artists</h3>
        ...
        >
          <div className="section-card text-center py-4">
            <p className="text-2xl font-cartoon text-primary">24/7</p>
            <p className="text-xs font-body text-muted-foreground">Music Mode</p>
          </div>
          <div className="section-card text-center py-4">
            <p className="text-2xl font-cartoon text-primary">100+</p>
            <p className="text-xs font-body text-muted-foreground">Saved Songs</p>
          </div>
          <div className="section-card text-center py-4">
            <p className="text-2xl font-cartoon text-primary">∞</p>
            <p className="text-xs font-body text-muted-foreground">Vibes</p>
          </div>
        </motion.div>
      </div>
    </div>
